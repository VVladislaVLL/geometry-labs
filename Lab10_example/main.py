...
def check_condition(point1, point2, vertex1, vertex2):
  ...
  # Проверка для 4-х угольника, если внутри окружности, то возвращает False, если всё хорошо - True
  ...
  for common_point in common_points:
    ...
    for point_right in common_points_right:
      for point_left in common_points_left:
        ...
        if not cond:
          try:
            # В случае не выполнения условия Делоне, меняем точки и проверяем варианты рекурсивно
