...
def draw_lines(sc, array: list, color=(0, 0, 0)):
  for i in range(len(array) - 1):
    pygame.draw.line(sc, color, array[i], array[i + 1])


def draw_cube(sc, cube_to_draw: list):
  draw_lines(sc, [cube_to_draw[0], cube_to_draw[1], cube_to_draw[3], cube_to_draw[2], cube_to_draw[0]])
  draw_lines(sc, [cube_to_draw[4], cube_to_draw[5], cube_to_draw[7], cube_to_draw[6], cube_to_draw[4]])
  draw_lines(sc, [cube_to_draw[0], cube_to_draw[4]])
  draw_lines(sc, [cube_to_draw[1], cube_to_draw[5]])
  draw_lines(sc, [cube_to_draw[2], cube_to_draw[6]])
  draw_lines(sc, [cube_to_draw[3], cube_to_draw[7]])
